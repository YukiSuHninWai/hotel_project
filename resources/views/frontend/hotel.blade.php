    ...
    <section class="standard-slider room-slider">
      <div class="col-sm-12 col-md-8">
        <div id="owl-standard" class="owl-carousel">
          <div class="item"> <a href="images/rooms/slider/750x481.gif" data-rel="prettyPhoto[gallery1]"><img src="{{asset('frontend/images/rooms/slider/750x481.gif')}}" alt="Image 2" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('images/rooms/slider/750x481.gif')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('frontend/images/rooms/slider/750x481.gif')}}" alt="Image 2" class="img-responsive"></a> </div>
        </div>
      </div>
    </section>
<!-- Room Content -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-7 mt50">
            <h2 class="lined-heading"><span>Facility</span></h2>
            <h3 class="mt50">Facility</h3>
          ...
          <div class="col-sm-5 mt50">
            ...
            <div class="tab-content">
              <div class="tab-pane fade in active" id="overview">
                ...
                <p><img src="{{asset('frontend/images/tab/197x147.gif')}}" alt="food" class="pull-right"> Donec pretium sem non tincidunt iaculis. Nunc at pharetra eros, a varius leo. Mauris id hendrerit justo. Mauris egestas magna vitae nisi ultricies semper. Nam vitae suscipit magna. Nam et felis nulla. Ut nec magna tortor. Nulla dolor sapien, laoreet vel tincidunt non, egestas non justo. </p>
              </div>
...
<section class="rooms mt50">
  <div class="container">
    <div class="row">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="{{asset('frontend/images/rooms/356x228.gif')}}" alt="room 1" class="img-responsive" />
          <div class="mask">
            <div class="main">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="{{asset('frontend/images/rooms/356x228.gif')}}" alt="room 2" class="img-responsive" />
          <div class="mask">
            <div class="main">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="{{asset('frontend/images/rooms/356x228.gif')}}" alt="room 3" class="img-responsive" />
          <div class="mask">
            <div class="main">
              <h5>Single room</h5>
